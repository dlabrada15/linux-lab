...
del sistema, detectar anomalias y generar reportes con
timestamp.
...
-u USUARIO  
Inspeccionar arbol de un usuario especifico

-t UMBRAL  
% CPU para clasificar como "alto consumo" (default: 50)

-k  
Enviar SIGTERM a procesos sobre el umbral

-r ARCHIVO  
Guardar reporte en ruta especifica
...
# Alto consumo para root

./monitor-procesos.sh -t 70 -k  
# Terminar procesos pesados
